...
if(count($tabs_list) > 0){
	$tab_bd_ids = [];
    ?>
    <div class="yhsshu-tabs layout-1">
        ...
        <div class="tabs-title">
            <div class="title-wrap">
                <?php foreach ($tabs_list as $key => $tab) :
                    ...
                    ?>
                    <a href="javascript:void(0)" <?php yhsshu_print_html($widget->get_render_attribute_string( $title_key )); ?> data-slide="<?php echo esc_attr($key); ?>">
