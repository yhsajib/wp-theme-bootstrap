...
if(count($tabs_list) > 0){
	$tab_bd_ids = [];
    ?>
    <div class="yhsshu-tabs layout-9">
        ...
        <div class="tabs-title">
            ...
            <div class="yhsshu-tab-arrows">
                <div class="yhsshu-tab-arrow yhsshu-tab-arrow-next"><span class="yhsshu-icon yhsshui-arrow-next"></span></div>
                <div class="yhsshu-tab-arrow yhsshu-tab-arrow-prev"><span class="yhsshu-icon yhsshui-arrow-prev"></span></div>
            </div>
        </div>
