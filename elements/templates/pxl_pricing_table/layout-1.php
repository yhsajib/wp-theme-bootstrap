...
?>
<div class="yhsshu-pricing-wrap <?php if (!empty($yhsshu_animate)){echo esc_attr($yhsshu_animate);} ?> <?php echo esc_attr($settings['style']);?>" data-wow-duration="1.4s" data-wow-delay="0.25s">
    <?php
