...
?>
<div class="yhsshu-grid yhsshu-image-gallery images-light-box layout-7" data-layout-mode="<?php echo esc_attr($layout_mode); ?>">
                ...
                <?php if (!empty($image)) : ?>
                    <div class="item-inner">
                        ...
                        <div class="up-icon">
                            ...
                            ?>
                            <a <?php yhsshu_print_html($link_attributes); ?>>
