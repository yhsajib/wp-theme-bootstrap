...
<div class="yhsshu-swiper-slider yhsshu-testimonial-carousel d-flex justify-content-center layout-<?php echo esc_attr($settings['layout'])?>">
    <?php
    $thumb_opts = [
    ...
    ?>
    <div class="yhsshu-swiper-thumbs-wrap">
    ...
    <div class="yhsshu-swiper-slider-wrap yhsshu-carousel-inner d-flex justify-content-center relative" style="background-image: url(<?php echo esc_url($settings['testimonial_background']['url']); ?>);">
        ...
        <?php yhsshu_arrow_template($settings, 'yhsshu-icon yhsshui-arrow-left' ,'yhsshu-icon yhsshui-arrow-right'); ?>
