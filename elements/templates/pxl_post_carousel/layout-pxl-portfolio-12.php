...
<div class="yhsshu-swiper-slider yhsshu-portfolio-carousel layout-<?php echo esc_attr($settings['layout']);?> ">
    ...
    <?php endif; ?>
    <div class="yhsshu-swiper-slider-wrap yhsshu-carousel-inner relative add-custom-cursor">
            ...
            <div class="yhsshu-swiper-wrapper swiper-wrapper">
                ...
                foreach ($posts as $post):
                    ...
                    <div class="yhsshu-swiper-slide swiper-slide" data-filter="<?php echo esc_attr($filter_class) ?>">
                        <div class="item-inner relative <?php echo esc_attr($item_anm_cls) ?>" <?php yhsshu_print_html($data_settings); ?>>
        ...
        <div class="yhsshu-swiper-arrows style-default nav-horizontal">
            <div class="yhsshu-swiper-arrow yhsshu-swiper-arrow-prev"><span class="yhsshui yhsshui-arrow-prev"></span></div>
            <div class="yhsshu-swiper-arrow yhsshu-swiper-arrow-next"><span class="yhsshui yhsshui-arrow-next"></span></div>
        </div>
