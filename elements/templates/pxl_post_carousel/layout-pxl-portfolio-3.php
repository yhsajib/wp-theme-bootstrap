...
<div class="yhsshu-swiper-slider yhsshu-portfolio-carousel <?php echo esc_attr($tab_style); ?> layout-<?php echo esc_attr($settings['layout']);?> ">
                ...
                foreach ($posts as $post):
                    ...
                    <div class="yhsshu-swiper-slide swiper-slide" data-filter="<?php echo esc_attr($filter_class) ?>">
                        <div class="item-inner relative">
                            ...
                            <?php endif; ?>
                            <div class="item-content remove-cursor d-flex <?php echo esc_attr($item_anm_cls) ?>" <?php yhsshu_print_html($data_settings); ?>>
                                <h4 class="item-title">
