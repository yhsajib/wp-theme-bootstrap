...
<div class="yhsshu-menu-list layout-6">
    <div class="yhsshu-item-list">
        ...
        foreach ($list as $key => $value):
            ...
            ?>
            <div class="yhsshu-menu-item<?php echo esc_attr($value['is_featured'] == 'yes' ? ' featured' : ''); ?> <?php echo esc_attr($animate_cls); ?> <?php echo 'elementor-repeater-item-' . $value['_id'] ?>" <?php yhsshu_print_html($data_settings); ?>>
