...
<div class="yhsshu-swiper-slider yhsshu-product-carousel yhsshu-shop-layout-42">
    <div class="yhsshu-swiper-slider-wrap yhsshu-carousel-inner relative">
        <div class="yhsshu-swiper-arrow yhsshu-swiper-arrow-prev"><?php echo esc_html('Previous', 'yhsshu'); ?></div>
        <div <?php yhsshu_print_html($widget->get_render_attribute_string( 'carousel' )); ?>>
            <div class="yhsshu-swiper-wrapper swiper-wrapper">
                ...
                while ($query->have_posts()) {
                    ...
                    wc_get_template( 'yhsshu-content-product-layout-4.php' );
                    echo '</div>';
                }
                wp_reset_postdata();
                ?>
        ...
        <div class="yhsshu-swiper-arrow yhsshu-swiper-arrow-next"><?php echo esc_html('Next', 'yhsshu'); ?></div>
