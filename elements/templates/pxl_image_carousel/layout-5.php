...
<div class="yhsshu-swiper-slider yhsshu-image-carousel layout-5">
    ...
    <div class="yhsshu-swiper-slider-wrap yhsshu-carousel-inner relative">
        ...
        <?php yhsshu_arrow_template($settings, 'yhsshui yhsshui-left-arrow', 'yhsshui yhsshui-right-arrow'); ?>
