 ...
 */
if (!class_exists("PXL_WXR_Parser")) {
    class PXL_WXR_Parser
    {
        function parse( $file ) {
            // Attempt to use proper XML parsers first
            if ( extension_loaded( 'simplexml' ) ) {
                $parser = new PXL_WXR_Parser_SimpleXML;
            ...
            $parser = new PXL_WXR_Parser_Regex;
 ...
 */
if (!class_exists("PXL_WXR_Parser_SimpleXML")) {
    class PXL_WXR_Parser_SimpleXML
    {
        function parse( $file ) {
 ...
 */
if (!class_exists("PXL_WXR_Parser_XML")) {
    class PXL_WXR_Parser_XML
    {
        var $wp_tags = array(
 ...
 */
if (!class_exists("PXL_WXR_Parser_Regex")) {
    class PXL_WXR_Parser_Regex
    {
        var $authors = array();
        var $posts = array();
