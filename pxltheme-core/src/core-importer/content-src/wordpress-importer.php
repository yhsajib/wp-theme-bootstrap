 ...
 */
if ( class_exists( 'WP_Importer' ) ) {
	class PXL_Import extends WP_Importer {
...
/*if( !function_exists('wordpress_importer_init') ) {
	function wordpress_importer_init() {
		...
		$GLOBALS['wp_import'] = new PXL_Import();
		register_importer( 'wordpress', 'WordPress', esc_html__('Import <strong>posts, pages, comments, custom fields, categories, and tags</strong> from a WordPress export file.', PXL_TEXT_DOMAIN), array( $GLOBALS['wp_import'], 'dispatch' ) );
	}
